...
const VideoPlay = () => {
    ...
    return (
        <>
            <Flex  >
                <Box w="100%" className="video-first-box" >
                    <Box w={["100%","900px"]}>
                ...
                <Grid backgroundColor="black" padding="5"  templateRows='repeat' templateColumns='repeat(2, 1fr)' display={{base:"none",md:"grid",lg:"grid"}}  gap={4}>
                <SingleCard/>
                <SingleCard/>
                <SingleCard/>
                <SingleCard/>
