...
export const NewsData = () => {
  ...
  return (
    <Box>
      ...
      <News data={popular} head="Popular Movies" />
      <News data={song} head="Songs" />
      <News data={premium} head="Premium" />
      <News data={serial} head="Serial" />
      <News data={live} head="Live" />
      <News data={kids} head="Kids" />
    </Box>
  );
};
